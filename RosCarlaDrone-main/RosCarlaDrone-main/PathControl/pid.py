...
class VelocityController:
    def __init__(self):
        ...
        self.pid_x = PIDController(kp=5.0, ki=0.075, kd=0.01, max_output=max_speed)
        self.pid_y = PIDController(kp=5.0, ki=0.075, kd=0.01, max_output=max_speed)
        self.pid_z = PIDController(kp=5.0, ki=0.075, kd=0.01, max_output=max_speed)
