...
class Drone:
    def __init__(self, world):
        ...
        # For map01 = (200,190,3)
        # For map02 = (190,240,3)
        self.initial_position = carla.Vector3D(190,240,1.6)
    ...
    def add_lidar_sensor(self):
        ...
        lidar_bp.set_attribute('lower_fov', '-70')
    ...
    def update_position(self, delta_time):
        ...
        # Aggiorna orientamento (da ROS arriva in rad/s)
        rotation.yaw += math.degrees(self.angular_velocity.z * delta_time)
        ...
        location += forward_vector * self.velocity.x * delta_time
        location.z = self.initial_position.z  # Mantieni l'altezza fissa
